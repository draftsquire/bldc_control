...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = TIM1_MECH_CH1_Pin|TIM1_MECH_CH2_Pin;
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = TIM3_OPT_CH1_Pin|TIM3_OPT_CH2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM10_MspInit 0 */
    ...
    PB8     ------> TIM10_CH1
    */
    GPIO_InitStruct.Pin = TIM10_IC_CH1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM10;
    HAL_GPIO_Init(TIM10_IC_CH1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA5     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = TIM2_PWM_CH1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, TIM1_MECH_CH1_Pin|TIM1_MECH_CH2_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, TIM3_OPT_CH1_Pin|TIM3_OPT_CH2_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM10_MspDeInit 0 */
    ...
    PB8     ------> TIM10_CH1
    */
    HAL_GPIO_DeInit(TIM10_IC_CH1_GPIO_Port, TIM10_IC_CH1_Pin);
